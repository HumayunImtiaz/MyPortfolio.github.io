  ...
  return (
    ...
    >
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1400px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            title="Software Engineer - Full-Stack"
            subTitle="VirtueNetz (Jan 2025 - Present)"
            result="On-site"
          ...
          />
          <ResumeCard
            title="CMIT Internship - Full-Stack Developer"
            subTitle="VirtueNetz (Jul 2025 - Jan 2026)"
            result="Internship"
            des="Completed CMIT internship at VirtueNetz, working on full-stack web development projects. Gained hands-on experience with modern technologies including Next.js, Node.js, and PostgreSQL in a professional environment."
          />
          <ResumeCard
