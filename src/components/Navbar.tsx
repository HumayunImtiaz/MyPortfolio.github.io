...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-20 sticky top-0 z-50 backdrop-blur-2xl transition-colors bg-bodyColor shadow-lg shadow-designColor/50 mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-white px-4">
      <div className="rounded-full">
        <img src={logo} alt="logo" className=" rounded-full h-[60px] w-[60px] "/>
      </div>
      <div>
        ...
        {showMenu && (
          <div className="w-[80%] h-screen mdl:hidden overflow-scroll absolute top-0 left-0 bg-black  p-4 scrollbar-hide">
